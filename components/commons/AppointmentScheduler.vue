      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          ...
          <div class="rounded-lg p-6">
            ...
            <div class="space-y-3 grid grid-cols-3 gap-2">
              <button
                v-for="timeSlot in availableTimeSlots"
                :key="timeSlot"
                @click="selectTimeSlot(timeSlot)"
                :class="[
                  'w-full py-3 px-4 rounded-lg font-medium transition-all duration-200 h-20',
          ...
          >
            ...
            <div class="space-y-3 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="text-white">{{ selectedTimeSlot }}</span>
              </div>
              <div class="flex justify-between">
...
const confirmAppointment = async () => {
  ...
  try {
    ...
    showSuccess(
      '¡Cita confirmada!',
      `Tu cita con Kevin Yarlequé ha sido programada para el ${formatSelectedDate.value} a las ${selectedTimeSlot.value}. Recibirás un recordatorio por correo electrónico.`
    )
